...
let recheiosDoces = [
    ...
    ["Creme de avelã x2 (NÃO INCLUSO)", 7.00],
...
let doisSaboresPizza = [
    ...
    ["Pizza Frango com catupiry", "Mussarela, frango, catupiry, orégano, tomate, azeitona e molho de tomate", 65.00],
    ...
    ["Pizza Costela acebolada", "Costela desfiado, molho de tomate especial, mussarela, cebola, azeitona e orégano", 68.00],
    ["Pizza Costela cremosa", "Costela desfiada ,molho especial, mussarela, catupiry, orégano", 73.00],
    ["Pizza Costela ao alho", "Costela desfiada, molho de tomate especial, alho frito, mussarela , azeite , azeitona e cebola", 71.00] ,
    ["Pizza Costela especial", "Costela desfiada, molho de tomate especial, cebola , catupiry, mussarela , tomate , bacon , azeitona e orégano", 76.00],
    ...
    ["Creme de avelã, morango, coco ralado, leite condensado e bis preto", "Nutella, morango, coco ralado, leite condensado e bis preto", 70.00],
    ["Creme de avelã", "Nutella", 70.00],
    ["Creme de avelã com kit kat", "Nutella com kit kat", 70.00],
    ["Creme de avelã com morango", "Nutella com morango", 70.00],
    ["Creme de avelã e confete", "Nutella e confete", 70.00],
    ["Creme de avelã morango e confete", "Nutella morango e confete", 70.00],
...
let bolas = [
    ...
    ["Sorvete Bola", "Mousse de creme de avelã", 4.50, 0],
    ...
    ["Sorvete Bola", "Banana com creme de avelã", 4.50, 0],
...
let milks1 = [
    ...
    ["Milk Shake 300 Ml", "Mousse de creme de avelã", precoMilks1, 0],
    ...
    ["Milk Shake 300 Ml", "Banana com creme de avelã", precoMilks1, 0],
...
let milks2 = [
    ...
    ["Milk Shake 400 Ml", "Mousse de creme de avelã", precoMilks2, 0],
    ...
    ["Milk Shake 400 Ml", "Banana com creme de avelã", precoMilks2, 0],
...
let milks3 = [
    ...
    ["Milk Shake 500 Ml", "Mousse de creme de avelã", precoMilks3, 0],
    ...
    ["Milk Shake 500 Ml", "Banana com creme de avelã", precoMilks3, 0],
...
let milks4 = [
    ...
    ["Milk Shake 700 Ml", "Mousse de creme de avelã", precoMilks4, 0],
    ...
    ["Milk Shake 700 Ml", "Banana com creme de avelã", precoMilks4, 0],
...
let doceGrande = [
    ...
    ["Pizza Doce (Grande)", "Creme de avelã, morango, coco ralado, leite condensado e bis preto", 70.00, 0],
    ["Pizza Doce (Grande)", "Creme de avelã", 70.00, 0],
    ["Pizza Doce (Grande)", "Creme de avelã com kit kat", 70.00, 0],
    ["Pizza Doce (Grande)", "Creme de avelã com morango", 70.00, 0],
    ["Pizza Doce (Grande)", "Creme de avelã e confete", 70.00, 0],
    ["Pizza Doce (Grande)", "Creme de avelã morango e confete", 70.00, 0],
...
let docePequena = [
    ["lista", "doces", "bordasPizza"],
    ["Pizza Doce (Média)", "Açai com leite ninho", 48.00, 0],
    ["Pizza Doce (Média)", "Açai com morango e nutella", 48.00, 0],
    ["Pizza Doce (Média)", "Banana, canela, queijo, calda de caramelo", 48.00, 0],
    ["Pizza Doce (Média)", "Creme ninho com morango", 48.00, 0],
    ["Pizza Doce (Média)", "Diamante negro", 48.00, 0],
    ["Pizza Doce (Média)", "Doce de leite com queijo", 48.00, 0],
    ["Pizza Doce (Média)", "Goiabada com queijo", 48.00, 0],
    ["Pizza Doce (Média)", "Laka", 48.00, 0],
    ["Pizza Doce (Média)", "Laka óreo", 48.00, 0],
    ["Pizza Doce (Média)", "Creme de avelã, morango, coco ralado, leite condensado e bis preto", 48.00, 0],
    ["Pizza Doce (Média)", "Creme de avelã", 48.00, 0],
    ["Pizza Doce (Média)", "Creme de avelã com kit kat", 48.00, 0],
    ["Pizza Doce (Média)", "Creme de avelã com morango", 48.00, 0],
    ["Pizza Doce (Média)", "Creme de avelã e confete", 48.00, 0],
    ["Pizza Doce (Média)", "Creme de avelã morango e confete", 48.00, 0],
    ["Pizza Doce (Média)", "Ouro branco", 48.00, 0],
    ["Pizza Doce (Média)", "Prestígio", 48.00, 0],
    ["Pizza Doce (Média)", "Sonho de valsa", 48.00, 0]
];
let doisSabores = [
...
let tapiocaDoce = [
    ...
    ["Tapioca doce", "Creme de avelã e coco", 18.00, 0],
    ["Tapioca doce", "Creme de avelã com banana", 18.00, 0],
...
function pedir(id, ext, inclusos) {
    if(aberto()){
        ...
        alert("Agradecemos a preferência, abriremos ás 15h (sábados e domingos ás 14h30).");
    }
}
